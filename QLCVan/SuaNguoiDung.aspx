...
<asp:Content ID="HeadC" ContentPlaceHolderID="head" runat="server">
  ...
  <style type="text/css">
    ...
    .page{max-width:1100px;margin:35px auto;background:#f8f9fa;border:1px solid #e5e7eb;border-radius:8px;
      box-shadow:0 2px 6px rgba(0,0,0,0.08);padding:45px 50px;}
    ...
    /* === Hiển thị đúng 1 mũi tên cho tất cả DropDownList (giống trang Thêm) === */
    select.form-select{
      ...
      background-color:#fff; border:1px solid #ccc; border-radius:6px; height:38px; font-size:14px;
    }
...
<asp:Content ID="BodyC" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="page">
      ...
      <div class="col-md-6">
        ...
        <div class="form-row">
          ...
          <div class="status-group">
            <label><asp:RadioButton ID="rdoKichHoat" runat="server" GroupName="TrangThai" Text="Kích hoạt" /></label>
            <label><asp:RadioButton ID="rdoKhongKichHoat" runat="server" GroupName="TrangThai" Text="Chưa kích hoạt" /></label>
          </div>
        </div>
      </div>

      <!-- Cột phải: giống trang Thêm -->
      <div class="col-md-6">
        <div class="form-row">
        ...
        <div class="form-row">
          ...
          <asp:TextBox ID="txtXacNhanMK" runat="server" CssClass="form-control" TextMode="Password" />
        </div>
    ...
    <div class="text-end mt-4">
      <asp:Button ID="btnQuayLai" runat="server" CssClass="btn btn-secondary me-2" Text="Quay lại" OnClick="btnQuayLai_Click" />
