        ...
        <div class="grid2">
          <div class="row-full field">
            ...
            <div class="field">
                ...
                <div class="ctl">
                    <asp:TextBox ID="txtSoCV" runat="server" CssClass="ipt" Enabled="False" placeholder="Số công văn"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="ctl select-wrap">
                    <asp:TextBox ID="txtTenloaiCV" runat="server" CssClass="sel" Enabled="False" placeholder="Tên loại"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="ctl select-wrap">
                    <asp:TextBox ID="txtCQBH" runat="server" CssClass="sel" Width="100%" Enabled="False" placeholder="Cơ quan ban hành"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="ctl select-wrap">
                    <asp:TextBox ID="TextDonvinhan" runat="server" CssClass="sel" Width="100%" Enabled="False" placeholder="Cơ quan ban hành"></asp:TextBox>
                </div>
            </div>
            <div class="field">
            ...
            <div class="row-full field">
                ...
                <div class="ctl">
                    <asp:TextBox ID="txtaTrichyeu" runat="server" CssClass="ta" TextMode="MultiLine" ReadOnly="true" Rows="6"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="row-full field">
                ...
                <div class="ctl">
                    <asp:TextBox ID="TextGhichu" runat="server" CssClass="ta" TextMode="MultiLine" ReadOnly="true" Rows="6"></asp:TextBox>
                </div>
            </div>
