...
<asp:Content ID="HeadContent" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        .form-field-full {
            ...
            .form-field-full .form-field-inner {
                display: flex;
                align-items: center;
                gap: 14px;
                width: 100%;
        ...
        <div class="form-container">
            ...
            <div class="form-grid">
                ...
                <div class="form-field">
                    ...
                    <div class="form-input-control">
                        <div class="form-field">
                            <%--<asp:Label ID="Label1" runat="server" Text="Đơn vị nhận:" CssClass="form-label"></asp:Label>--%>
                            <div class="form-input-control">
                                <!-- Danh sách chọn nhiều đơn vị nhận -->
                                <asp:ListBox ID="lstDonViNhan" runat="server" CssClass="form-listbox" SelectionMode="Multiple"></asp:ListBox>
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="lstDonViNhan"
                                    InitialValue="" ErrorMessage="* Chọn ít nhất một đơn vị nhận" CssClass="note-red" />
                            </div>
                        </div>
