...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <style>
    ...
    /* ===== Phần tiêu đề và chạy chữ giống trang Loại Công văn / QLNhom ===== */
    .content-header {
...
.welcome-bar marquee {
  ...
  color: #fff;
    ...
    .cv-badge{position:absolute;right:22px;top:14px;background:red;color:#fff;
  ...
  <!-- ===== Phần nội dung chi tiết công văn ===== -->
  <div class="cv-wrap">
    <div class="cv-card">
      <div class="cv-head">
        <h5 class="cv-title">CHI TIẾT CÔNG VĂN</h5>
        <span class="cv-badge">Không duyệt</span>
      </div>
