    ...
    <center>
        ...
        <div id="contentLg">
            ...
            <div style="width: 250px; height: 38px; margin-top: 30px; ">
                <asp:TextBox ID="Username" runat="server" Width="250px"  CssClass="txtdn" Height="33px" placeholder="Tài khoản"></asp:TextBox>
            </div>
            <br />
            <div style="width: 250px; height: 38px;">
                <asp:TextBox ID="Password" runat="server" Width="250px" Height="33px" CssClass="txtdn" TextMode="Password"
