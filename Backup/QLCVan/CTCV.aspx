    ...
    <center>
        ...
        <div style="width: 750px; border-radius: 5px;">
            <table style="width: 750px; background-color: #F7F6F3;">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label11" runat="server" Enabled="False" Text="Trích yếu :"></asp:Label>
                    </td>
                    <td colspan="6">
                ...
                <tr>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label10" runat="server" Text=" Phê duyệt :"></asp:Label>
                        </td>
                        <td>
                            <asp:Button ID="btnPheduyet" runat="server" Text="OK" Height="41px" OnClick="btnPheduyet_Click"
                                Width="62px" />
                        </td>
                    </tr>
                    <tr>
